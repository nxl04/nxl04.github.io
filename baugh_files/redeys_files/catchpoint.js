var generateUniqueID = function() {
...
}, firstHiddenTime = -1, initHiddenTime = function() {
...
}, bindReporter = function(n, t, i) {
  var r;
  return function(u) {
    t.value >= 0 && (u || i) && (t.delta = t.value - (r || 0), (t.delta || r === undefined) && (r = t.value, n(t)));
  };
  ...
  try {
    if (PerformanceObserver.supportedEntryTypes.indexOf(n) > -1) {
      if (n === 'first-input' && !('PerformanceEventTiming' in self)) return;
      var i = new PerformanceObserver(function(n) {
        return n.getEntries().map(t);
      });
      return i.observe({ type: n, buffered: !0 }), i;
    }
  } catch (r) {
  }
  return;
}, getFCP = function(n, t) {
  var o = getVisibilityWatcher(), i = initMetric('FCP'), r, e = function(n) {
      n.name === 'first-contentful-paint' && (f && f.disconnect(), n.startTime < o.firstHiddenTime && (i.value = n.startTime, i.entries.push(n), r(!0)));
    },
    u = window.performance && performance.getEntriesByName && performance.getEntriesByName('first-contentful-paint')[0],
    f = u ? null : observe('paint', e);
  (u || f) && (r = bindReporter(n, i, t), u && e(u), onBFCacheRestore(function(u) {
    i = initMetric('FCP');
    r = bindReporter(n, i, t);
  ...
  return { name: n, value: typeof t == 'undefined' ? -1 : t, delta: 0, entries: [], id: generateUniqueID() };
}, isMonitoringFCP = !1, fcpValue = -1, reportedMetricIDs = {}, getLCP = function(n, t) {
  var o = getVisibilityWatcher(), i = initMetric('LCP'), r, e = function(n) {
    var t = n.startTime;
    t < o.firstHiddenTime && (i.value = t, i.entries.push(n), r(!1));
  }, u = observe('largest-contentful-paint', e), f;
  u && (r = bindReporter(n, i, t), f = function() {
    reportedMetricIDs[i.id] || (u.takeRecords().map(e), u.disconnect(), reportedMetricIDs[i.id] = !0, r(!0));
  }, ['keydown', 'click'].forEach(function(n) {
    addEventListener(n, f, { once: !0, capture: !0 });
  }), onHidden(f, !0), onBFCacheRestore(function(u) {
    i = initMetric('LCP');
    r = bindReporter(n, i, t);
    requestAnimationFrame(function() {
      requestAnimationFrame(function() {
  ...
  isMonitoringFCP || (getFCP(function(n) {
    fcpValue = n.value;
  }), isMonitoringFCP = !0);
  var e = function(t) {
    fcpValue > -1 && n(t);
  }, i = initMetric('CLS', 0), f, r = 0, u = [], o = function(n) {
    if (!n.hadRecentInput) {
      var t = u[0], e = u[u.length - 1];
      r && n.startTime - e.startTime < 1e3 && n.startTime - t.startTime < 5e3 ? (r += n.value, u.push(n)) : (r = n.value, u = [n]);
      r > i.value && (i.value = r, i.entries = u, f(!0));
    }
  }, s = observe('layout-shift', o);
  s && (f = bindReporter(e, i, t), onHidden(function() {
    s.takeRecords().map(o);
    f(!0);
    ...
    fcpValue = -1;
    i = initMetric('CLS', 0);
    f = bindReporter(e, i, t);
  }));
}, windowCurrent = parent.window || window, WindowEvent, VisibilityType;
(function(n) {
  n.Load = 'load';
  ...
  n.Error = 'error';
  n.Unload = 'unload';
})(WindowEvent || (WindowEvent = {})), function(n) {
  n[n.Focus = 0] = 'Focus';
  n[n.Blur = 1] = 'Blur';
...
var AjaxTiming = function() {
  ...
  return n.prototype.add = function(n, t, i) {
    this.events.push({ type: n, target: t, func: i });
    ...
    var r = this.events.indexOf({ type: n, target: t, func: i });
      ...
      window.fetch && (window.fetch = function(t) {
        return function() {
          ...
          return o = 0, f = Promise.resolve(s), f = f.then(function(t) {
            var r, u = {}, e, f;
            if (t.length && t.length >= 1) r = t[0], t.length > 1 && (u = t[1]); else return [];
  ...
  return n.prototype.getAjaxRequests = function() {
    ...
    setTimeout(function() {
      var f, o, s, h, e;
      if (i.hasPerformance) {
        var u = n.url, r = [], c = performance.getEntriesByType('resource');
    ...
    var t = XMLHttpRequest.prototype, r = t.open, u = t.send, i = [];
    ...
    t.send = function(t) {
      var r = this, e = this.onreadystatechange, f;
      (this.onreadystatechange = function(t) {
        var u = i[r.rpIndex], o, f;
        if (u) {
          o = r.readyState;
  ...
  function n () {
    function o (n) {
      ...
      return t.nodeType == 3 && (t = t.parentNode), r('N/A', t.src || t.URL, -1), !1;
    }

    var n = this, r, u, e, t, i, f;
    this.restUrl = 'g.3gl.net/jp/9352/v3.3.6/M';
    ...
    this.setCLS = function(t) {
      var i = t.name, r = t.delta, u = i === 'CLS' ? r : undefined;
      n.cls = u;
    };
    this.setLCP = function(t) {
      var i = t.name, r = t.delta, u = i === 'LCP' ? r : undefined;
      n.lcp = u;
    };
    ...
    this.addError = function(t, i, r) {
      var s, f, u, e, o;
      for (n.data.jsCount++, s = ProfilerJsError.createText(t, i, r), f = n.data.jsErrors, u = 0, e = f; u < e.length; u++) if (o = e[u], o.getText() == s) {
        o.count++;
        return;
      }
    ...
    this.addInfo = function(t, i, r) {
      if (!n.isNullOrEmpty(t)) {
        if (n.isNullOrEmpty(r)) n.info[t] = i; else {
    ...
    this.getCPWebVitals = function() {
      return getCLS(n.setCLS, !1), getLCP(n.setLCP, !1), { cls: n.cls, lcp: n.lcp };
    };
    ...
    window.opera ? this.eventManager.add(WindowEvent.Error, document, o) : 'onerror' in window && (u = window.onerror, window.onerror = function(n, t, i) {
      return (r(n, t, i), !!u) ? u(n, t, i) : !1;
    });
    ...
    t.addEventListener('load', function(t) {
      var r = t.currentTarget, u, i;
      r && r.contentDocument && (u = r.contentDocument, i = u.createElement('script'), i.type = 'text/javascript', i.src = e + '//' + n.restUrl, u.body.appendChild(i));
    });
  ...
  function n () {
    ...
    this.captureVisibilityEvent = function(t) {
      n.visibilityEvents.push({ type: t, time: n.now() });
    };
    ...
    this.getFocusAwayTime = function() {
      var i = n.visibilityEvents, t = -1, s, h, o;
